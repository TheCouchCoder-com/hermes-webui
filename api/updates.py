...
def channel_version_badge(channel=None) -> str:
    ...
    return WEBUI_VERSION  # noqa: F821  WEBUI_VERSION is a PEP 562 module attribute (module __getattr__), invisible to static analysis
...
def _check_repo_release(path, name, channel=DEFAULT_UPDATE_CHANNEL):
    ...
    if current_tag is None:
        ...
        if name == "webui":
            current_version_display = WEBUI_VERSION  # noqa: F821  WEBUI_VERSION is a PEP 562 module attribute (module __getattr__), invisible to static analysis
