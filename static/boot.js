...
(async()=>{
  ...
  // (composer + fork titlebar chip), and reveal the titlebar chip wrap once we
  // know the active profile.
  ...
  // gated by _showTitlebarProfile) in sync immediately — a distinct element
  // from the fork's titlebar chip above, see _applyTitlebarProfileVisibility.
